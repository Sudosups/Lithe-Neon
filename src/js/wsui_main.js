...
let jtfr = {
   tFind:  [
        "Lithe",
        "https://github.com/Sudosups/Lithe-Neon",
        "Lithe",
        "Lithe",
        "lithe-service"
    ],
...
function showInitialPage(){
    ...
    let versionInfo = document.getElementById('LitheNeonVersion');
    if(versionInfo) versionInfo.innerHTML = WS_VERSION;
    let tsVersionInfo = document.getElementById('litheServiceVersion');
...
ipcRenderer.on('cleanup', () => {
    ...
    let htmlText = 'Terminating Lithe Neon...';
